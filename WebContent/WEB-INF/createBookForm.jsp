...
<h1>Renseigner un nouveau livre</h1>
<form method="post" action="AddBook">
	...
	<div class="input-group">
		...
		<input class="form-control" type='text'  name='editeur'/>  
	</div>
	<div class="input-group">
	...
	<div class="input-group">
	<span class="input-group-addon" id="sizing-addon1">Année de publication :</span>
		<select class="form-control" name = "anneePubli">
	...
	<div class="input-group">
		...
		<textarea class="form-control" name="resume" rows="10" cols="50"></textarea> 
	</div>
	<div class="row">
