...
> Gestion des matches : <a href="choixAlgoMatchForm.jsp">Choisir les algorithmes</a> / <a href="ChoixAlgoServlet?action=afficher">Consulter l'historique des paramètres de match<br>
<br>
</body>
</html>